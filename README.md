...
Um die verschiedenen Praktiken zu finden, klicken Sie auf "Branches" und wählen sie den jeweiligen Branch aus (z.B. `praktikum-1`).

Die verschiedenen Branches bauen aufeinander, d.h. `praktikum-2` basiert auf `praktikum-1` und so weiter. 
Dieser `main` branch ist lediglich als Übersicht gedacht.
